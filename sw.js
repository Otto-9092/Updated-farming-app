/* ============================================================
   ...
   ============================================================ */
const CACHE_VERSION = "opio-2026.08.02-12";
...
const CORE_ASSETS = [
  "./",
  "./styles.css?v=20260802-12",
  "./config.js?v=20260802-12",
  "./app.js?v=20260802-12",
  "./uxenhancements.js?v=20260802-12",
  "./asapplied.js?v=20260802-12",
