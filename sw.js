/* ============================================================
   ...
   ============================================================ */
const CACHE_VERSION = "opio-2026.09.08-21";
...
const CORE_ASSETS = [
  "./",
  "./styles.css?v=20260908-21",
  "./seedtag.css?v=20260908-21",
  "./config.js?v=20260908-21",
  "./app.js?v=20260908-21",
  "./uxenhancements.js?v=20260908-21",
  "./asapplied.js?v=20260908-21",
  "./seedtag.js?v=20260908-21",
  "./handbook.js?v=20260908-21",
  "./manifest.json",
  "./icon-16.png",
  "./icon-32.png",
  "./icon-192.png",
