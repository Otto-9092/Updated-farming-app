/* ============================================================
   ...
   ============================================================ */
const CACHE_VERSION = "opio-2026.08.02-16";
...
const CORE_ASSETS = [
  "./",
  "./styles.css?v=20260802-16",
  "./config.js?v=20260802-16",
  "./app.js?v=20260802-16",
  "./uxenhancements.js?v=20260802-16",
  "./asapplied.js?v=20260802-16",
  "./manifest.json",
  "./icon-16.png",
  "./icon-32.png",
  "./icon-192.png",
